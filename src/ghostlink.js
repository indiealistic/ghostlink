...
class GhostLink {
  ...
  */
  _engage(target) {
    ...
    target.setAttribute('data-ghostlink', 'engage');
  ...
  */
  _dispatch(target) {
    ...
    target.setAttribute('data-ghostlink', 'dispatch');
  ...
  */
  _cancel(target) {
    ...
    target.setAttribute('data-ghostlink', 'cancel');
  }
